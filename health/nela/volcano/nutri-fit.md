...
# Seccion de Nutricion Deportiva
...
### Fases de la alimentacioń del deportista (debe coincidir con el ciclo de entrenamiento):
...
* Realizar 1 día previo a la competición.
* Consumir alimentos comunes para evitar problemas gástricos.
...
| Desayuno | Merienda de MM | Almuerzo | Merienda de MT | Cena |
| :-: | :-: | :-: | :-: | :-: |
| 1 taza de pinto + 1 rebanada de pan blanco + 2 huevos | 1 banano | 1 taza de arroz + 1 papa mediana + 150gr de proteína + vegetales cocidos | Sándwich de pavo y queso. 1 banano | 2 taza de pasta en tomate natural. |

# Alimentación Pre-Competencia

## Indicaciones:
* Cubrir de 1 a 4gr de CHO/Kg de peso y 0,15gr de PROT/kg de peso 1 o 3 horas antes.
* Total por consumir: 141gr de CHO + 14gr de PROT 3 horas antes.
* 3-4 horas antes consumir de 5 a 7ml/kg de peso total en las 4 horas anteriores. Aproximadamente entre 300 a 400mL de líquido divido en tomas.
* Si se requiere consuma 200mL la hora previa. Consuma Bebida Hidratante. (Este es indispensable si la orina es de color amarillo intenso).

## Opcion 1

| Alimentos | Carbohidratos (gr) | Proteina (gr) | 
| :-: | :-: | :-: | 
| 2 horas antes:
3 rebanadas de pan blanco + mermelada + 1 banano | 114 |
| Total | 114gr (1.2gr/kg) | 14 gr |

## Alimentación Durante la Competencia o Entrenamiento

### Indicaciones:
* Cubrir 400mg de Sodio por hora después de 3 horas de carrera, entrenamientos o en ambientes húmedos.
* Consumir entre 30 y 60gr de CHO por hora. Podría consumir 30gr para entrenamientos de baja intensidad y 60gr para carrera.
* Ingerir entre 500 y 600mL líquido. Recuerde verificar su tasa de sudoración.

## Opcion 1 - Consumo por hora

| Alimentos | Carbohidratos | Sodio | liquido |
| :-: | :-: | :-: | :-: |
| 1 gel Gu | 22 |
| 2 scoops de Tailwind + 1 Nuun | 50 | 1010 | 600 -700ml |
| 1 pastilla de sal |  | 250 |
| Total | 72gr | 1260mg | 600ml |